...
![Micro Frontends](https://img.shields.io/badge/Micro--Frontends_Module_Federation-6C63FF?style=for-the-badge)

### Security & Auth
![OIDC](https://img.shields.io/badge/OIDC%2FSSO-005A9C?style=for-the-badge&logo=openid&logoColor=white)
![JWT](https://img.shields.io/badge/JWT-000000?style=for-the-badge&logo=jsonwebtokens&logoColor=white)

### Testing
![Jasmine](https://img.shields.io/badge/Jasmine-8A4182?style=for-the-badge&logo=jasmine&logoColor=white)
![Karma](https://img.shields.io/badge/Karma-56C5A1?style=for-the-badge)
...
| 📊 [angular-fintech-dashboard](https://github.com/PrabakarKaruppasamy/angular-fintech-dashboard) | Real-time-style portfolio dashboard with live market ticker, NgRx state, Chart.js visualisations, RBAC and JWT auth — [Live Demo ↗](https://angular19-fintech-dashboard.vercel.app/login) | Angular 19, NgRx, Signals, Chart.js | ✅ Live |
...
| 📦 ngx-signals-forms | Signal-based reactive forms library for Angular 19 — zero BehaviorSubject, pure Signals API. Published to NPM. | Angular 19, Signals, TypeScript, Vitest | 🚧 In Progress |
...
✅ Mentored 3 junior developers to full independent feature delivery
```
...
> *"Good architecture is not about the tools you use — it's about the problems you solve and the teams you enable."*
